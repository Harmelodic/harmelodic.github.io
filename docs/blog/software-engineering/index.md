...
- Development practices (Version Control, Package management (+SemVer), IDEs, error handling, onboarding checklist,
  automate it, documentation (handbook, system docs), code style)
- Operational work (Monitoring & Alerting, SLIs/SLOs/SLAs)
...
- **Platform**
	...
	- Compute platform (compute options (serverless, kubernetes, VMs, hardware), service-mesh)
