...
There's lots of interesting things to read on the internet. I used to have these as bookmarks, but that isn't a good
place for helping others discover interesting things to read. Most of these aren't software engineering-related, since
they end up being referenced in my [writing on Software Engineering](../software-engineering/index.md), but some of them
may be technology or software engineering-related, and might still be interesting to non-engineers.

> This list is not an endorsement or showing of agreement of the ideas / points / authors / whatever that are behind
...
- [Falsehoods Programmers Believe About Aviation](https://flightaware.engineering/falsehoods-programmers-believe-about-aviation/)
  by Ben Burwell, FlightAware Engineering Blog.

- [Falsehoods Programmers Believe About Time](https://gist.github.com/timvisee/fcda9bbdff88d45cc9061606b4b923ca),
  crowdsourced falsehoods, crowdsourcing done by Noah Sussman, Gist compilation by Tim Visée.

- [Falsehoods Programmers Believe About Names](https://www.kalzumeus.com/2010/06/17/falsehoods-programmers-believe-about-names/)
  by Patrick MacKenzie, the original "Falsehoods Programmers Believe About..." article.
...
- [Pixar's 22 Rules of Storytelling](https://imgur.com/a/fPLnM) by Dinolgnacio, imgur.com.

- [The Power of Metaphor](https://www.youtube.com/playlist?list=PLMwThGuAEphsmL9KcAb391-xtafOy2TVy) by Mike Hill
  (YouTube videos, not a read).
